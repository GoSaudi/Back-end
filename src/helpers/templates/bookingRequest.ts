...
export default ({ vendorName, ticketCount, activityName, activityId }) => {
  return `<!DOCTYPE html>
  <html lang="en">
  <head>
      <meta charset="UTF-8">
                          ...
                          <tr>
                              <td style="padding: 30px 20px; font-family: 'Cabin', sans-serif; color: #000;">
                                  <div style="color: #000000; line-height: 160%; text-align: center; word-wrap: break-word;">
                                      ...
                                      <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">A customer has requested to book ${ticketCount} tickets for your activity - ${activityName}.</span></p>
                                      <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">This request has been created because the customer has requested more than the tickets available for your activity.</span></p>
                                      <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">Click on the below button to review the request.</span></p>
                                  </div>
                              </td>
                          </tr>
                          <tr>
                              <td style="padding: 10px; text-align: center;">
                                  ...
                                  }/vendor/activity/${activityId}" target="_blank" style="text-decoration: none; background-color: rgb(32, 120, 61); color: #fff; border-radius: 4px; padding: 14px 44px; display: inline-block; font-size: 16px; font-family: 'Cabin', sans-serif;">REVIEW REQUEST</a>
                              </td>
                          </tr>
                              ...
                              <td style="padding: 30px 20px; font-family: 'Cabin', sans-serif; color: #000;">
                                  <div style="color: #000000; line-height: 160%; text-align: center; word-wrap: break-word;">
                                      <p style="font-size: 15px; line-height: 28.8px;">Alternatively, you can directly paste this link in your browser: <br /><a href="${
                                        process.env.STRAPI_ADMIN_FRONTEND_URL
                                      }/vendor/activity/${activityId}" style="text-decoration: none; color: #0077FF;">${
    process.env.STRAPI_ADMIN_FRONTEND_URL
  }/vendor/activity/${activityId}</a></p>
                                  </div>
                              </td>
                          </tr>
                      </table>
