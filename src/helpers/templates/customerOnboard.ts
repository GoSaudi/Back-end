...
export default ({ customerName, token, email }) => {
  return `<!DOCTYPE html>
  <html lang="en">
  <head>
      <meta charset="UTF-8">
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; background-color: rgb(32, 120, 61); text-align: center;">
                          ...
                          <tr>
                              <td style="padding: 10px; font-family: 'Cabin', sans-serif; color: #fff;">
                                  <p style="font-size: 14px;"><strong>THANKS FOR SIGNING UP!</strong></p>
                                  <p style="font-size: 14px;"><strong>Welcome to go-saudi!</strong></p>
                                  <p style="font-size: 28px;"><strong>Verify Your E-mail Address</strong></p>
                              </td>
                          </tr>
                      </table>
                  </div>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; background-color: #fff;">
                          ...
                          <tr>
                              <td style="padding: 10px; text-align: center;">
                                  ...
                                  }/verify-token/?token=${token}&email=${email}" target="_blank" style="text-decoration: none; background-color: rgb(32, 120, 61); color: #fff; border-radius: 4px; padding: 14px 44px; display: inline-block; font-size: 16px; font-family: 'Cabin', sans-serif;">VERIFY YOUR EMAIL</a>
                              </td>
                          </tr>
                              ...
                              <td style="padding: 30px 20px; font-family: 'Cabin', sans-serif; color: #000;">
                                  <div style="color: #000000; line-height: 160%; text-align: center; word-wrap: break-word;">
                                      <p style="font-size: 15px; line-height: 28.8px;">Alternatively, you can directly paste this link in your browser: <br /><a href="${
                                        process.env.STRAPI_ADMIN_FRONTEND_URL
                                      }/verify-token/?token=${token}&email=${email}" style="text-decoration: none; color: #0077FF;">${
    process.env.STRAPI_ADMIN_FRONTEND_URL
  }/verify-token/?token=${token}&email=${email}</a></p>
                                  </div>
                              </td>
                          </tr>
                      </table>
