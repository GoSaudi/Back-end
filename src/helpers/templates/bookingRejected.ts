...
export default ({ customerName, activityName }) => {
  return `<!DOCTYPE html>
  <html lang="en">
  <head>
      <meta charset="UTF-8">
                          ...
                          <tr>
                              <td style="padding: 30px 20px; font-family: 'Cabin', sans-serif; color: #000;">
                                  <div style="color: #000000; line-height: 160%; text-align: center; word-wrap: break-word;">
                                      ...
                                      <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">Your Booking Request for the activity - ${activityName} has been rejected.</span></p>
                                      <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">Sorry for your time and effort.</span></p>
                                      <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">Would you like to browse for a different activity?</span></p>
                                  </div>
                              </td>
                          </tr>
                          <tr>
                              <td style="padding: 10px; text-align: center;">
                                  ...
                                  }/" target="_blank" style="text-decoration: none; background-color: rgb(32, 120, 61); color: #fff; border-radius: 4px; padding: 14px 44px; display: inline-block; font-size: 16px; font-family: 'Cabin', sans-serif;">FIND ACTIVITY</a>
                              </td>
                          </tr>
